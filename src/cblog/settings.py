...
DATABASES = {
    'default': {
        ...
        'HOST': 'capsrds.cb0hgtz8ljxr.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'awscapstones3yildizblog' # please enter your s3 bucket name
